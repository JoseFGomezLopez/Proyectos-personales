...
lista3 = [1, "hola", 3.14, True] # pyright: ignore[reportUnknownVariableType] # lista de tipos mixtos

lista_vacia = []
lista_de_listas = [[1, 2], ['calcetin', 4]] # pyright: ignore[reportUnknownVariableType]
matrix = [[1, 2], [2, 3], [4, 5]]

print(lista1)
print(lista2)
print(lista3)  # type: ignore
print(lista_vacia)  # pyright: ignore[reportUnknownArgumentType]
print(lista_de_listas)  # pyright: ignore[reportUnknownArgumentType]
print(matrix)
...
print(lista_de_listas[1][0])  # pyright: ignore[reportUnknownArgumentType]
