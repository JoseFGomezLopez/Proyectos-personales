...
# redondea al par mas cercano, pero si es 3.5 rendodea a 4!! # los pares hacia abajo, los impares hacia arriba
print(round(4.5))  # Redondea 2.51 al entero más cercano. Resultado: 3
